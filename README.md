...
1. Im Terminal: `napari`

2. Lade die Datei `mouse_atlas.tif`

3. Erkunde das Mausgehirn und finde den linken Barrel-Cortex in 3D oder 2D.
...
1. Im Terminal: `python get_cell_activity.py frames.tif labels.tif`
